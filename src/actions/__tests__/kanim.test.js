...
describe('auth', () => {
  ...
  it('should return get offices action creator, async', () => {
    ...
    const expectedActions = [
      ...
      { type: GET_OFFICES.SUCCESS, payload: [
        { MO_ID: 1, MO_NAME: 'Kanim 1' },
        { MO_ID: 2, MO_NAME: 'Kanim 2' },
        { MO_ID: 3, MO_NAME: 'Kanim 3' },
      ]},
  ...
  it('should return get office action creator, async', () => {
    nock(apiUrl)
      ...
      .reply(
        200,
        { success: true, data: { MO_ID: 1, MO_NAME: 'Kanim 1' }},
      );
  ...
  it('should return confirm office quota action creator, async', () => {
    nock(apiUrl)
      ...
      .reply(
        200,
        { success: true, data: { timingID: 12345 }},
      );

    const expectedActions = [
      { type: CONFIRM_QUOTA.ATTEMPT, },
      { type: CONFIRM_QUOTA.SUCCESS, payload: {
        timingID: 12345,
        kanimID: 1,
        date: 1234,
        startHour: 'startHr',
