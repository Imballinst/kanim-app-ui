        ...
        >
          <View style={{ padding: 11 }}>
            <Text style={style.modalText}>
              Apakah Anda yakin ingin membatalkan antrian ini? Antrian yang sudah dibatalkan tidak
    ...
    return (
      <View style={style.viewStyle}>
        <Text style={{ marginTop: 15 }}>
          Untuk melihat QR code, lakukan tap pada antrian yang diinginkan. Untuk melakukan delete,
          tekan antrian yang diinginkan selama 1 detik.
        </Text>
